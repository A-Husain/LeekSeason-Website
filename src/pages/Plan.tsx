...
const packageDetails: Record<string, { name: string; price: string }> = {
  basic: { name: 'Basic Package', price: '$2,500' },
  advanced: { name: 'Advanced Package', price: '$5,000' },
  elite: { name: 'Elite Package', price: '$10,000' },
  negotiated: { name: 'Negotiated Package', price: 'Custom Pricing' },
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-[#1a1a1a] border border-[#C0C0C0]/30 p-8">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div>
              <label className="block text-sm font-medium text-white mb-2">
                Project Notes <span className="text-gray-400">(optional)</span>
              </label>
              <textarea
                ...
                placeholder="Share any additional details about your project or goals..."
              />
            </div>
          </div>
